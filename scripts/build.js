...
console.log(
  `   ✓ Copied ${cssFiles.filter((f) => f.endsWith(".css")).length} CSS file(s)`,
);
...
// 7. Copy fonts folder
console.log("\n6. Copying fonts folder...");
const fontsSourceDir = path.join(__dirname, "..", "fonts");
const fontsDestDir = path.join(BUILD_DIR, "fonts");
if (fs.existsSync(fontsSourceDir)) {
  copyRecursiveSync(fontsSourceDir, fontsDestDir);
