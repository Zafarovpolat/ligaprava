...
**Цель:** Перенос на 1C-Битрикс с SPA-переходами (Barba.js) и поддержкой SEO
  ...
  transitions: [{
    ...
    leave(data) {
      ...
      return new Promise(resolve => {
        ...
        bubble.style.transform = 'translateX(-50%) translateY(-50%) scale(15)';
...
barba.hooks.after((data) => {
  ...
  const nextDesc = data.next.html.match(/<meta name="description" content="(.*?)"/);
  if (nextDesc) {
  ...
  // Обновить canonical
  const nextCanonical = data.next.html.match(/<link rel="canonical" href="(.*?)"/);
  if (nextCanonical) {
